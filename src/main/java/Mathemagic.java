...
public class Mathemagic {
    ...
    public static double periRect(int length, int width) {return length * 2 + width * 2;}


    public static double trapArea(int base1, int base2, int height) {return (base1 + base2) / 2f * height;}


    public static double conicVol(double radius, int height) {return (PI * radius * radius) * height / 3;}
    ...
    public static double atmoShift(double fahr) {return (fahr - 32) / 1.8;
    }


    public static double elevationVect(int x1, int y1, int x2, int y2) {return (float)(y2 - y1) / (x2 - x1);
    }
